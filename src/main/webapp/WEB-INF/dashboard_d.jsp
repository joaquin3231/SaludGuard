		...
		<nav class="navbar navbar-custom navbar-expand-lg">
			<div class="container-fluid">
				<a class="navbar-brand" href="#"> <img id="logo1"
					...
					<span class="ms-2"> |   Panel del profesional   |  
						Paciente: ${antecedentTemp.patient.user.firstName}
						${antecedentTemp.patient.user.lastName} </span>
				</a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"><span class="doctorData">${doctTemp.user.lastName},
								${doctTemp.user.firstName} | MM.NN: ${doctTemp.medLicense}     </span>
							<a id="logout" class="btn btn-custom" href="/logout">Cerrar
								sesión</a></li>
					</ul>
				</div>
			</div>
							...
							<table class="table table-striped">
								<thead>
									<tr>
										...
										<th><i class="fas fa-sticky-note fa-sm"></i>
											Observaciones</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${assesmentList}" var="assesment">
										<tr>
											...
											<td>${assesment.doctor.user.firstName}
												${assesment.doctor.user.lastName}</td>
					...
					<div class="content">
						...
						<c:if test="${ treatment != null }">
							...
							<p class="ml-2 description">
								<b>     Descripción: </b> <br> <span>     ${ treatment.description }</span>
							</p>
						</c:if>
				...
				<div class="inf">
					...
					<div class="content">
						...
						<c:if test="${ antecedentDate != null }">
							...
							<p>
								Título: <br> ${ antecedent.title }
							</p>
							<p>
								Descripción <br> ${ antecedent.description }
							</p>
						</c:if>
					</div>
