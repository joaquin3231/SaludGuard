...
<body class="radio-canada-big-body">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
					<li class="nav-item"><span class="doctorData">${doctTemp.user.lastName},
							${doctTemp.user.firstName} | MM.NN: ${doctTemp.medLicense}     </span> <a
						id="logout" class="btn btn-custom" href="/admin/logout">Cerrar
							sesión</a></li>
				</ul>
			</div>
		</div>
	...
	<div
		class="row mt-5 vh-90 vw-35 justify-content-center align-items-center">
		<div class="text-center mb-3">
			<h4>Le damos la bienvenida a SaludGuard,
				${doctTemp.user.firstName}</h4>
		...
		<div class="form-container">
			...
			<form action="/getPatient" method="POST">
				<label>Número de DNI del paciente a tratar (sin puntos ni
					espacios):</label> <input class="mt-2 input" type="text" placeholder="DNI"
					name="dniPaciente" required="required"> <input
					type="submit" class="mt-2 btn btn-dark"
					value="Confirmar y comenzar consulta"></input>
			</form>
		</div>
	</div>
