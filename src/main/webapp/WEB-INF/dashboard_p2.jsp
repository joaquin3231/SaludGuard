			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"><span class="patientData">
								Paciente: ${userInSession.lastName}, ${userInSession.firstName}
								    </span> <a id="logout" class="btn btn-custom" href="/logout">Cerrar
								sesión</a></li>
					</ul>
				</div>
			</div>
				...
				<div class="sup">
					...
					<div class="content">
						...
						<c:if test="${ physicalDetail != null }">
							<div class="contIzq">
								<p>
									Altura (en m):<br> ${ physicalDetail.height }
								</p>
								<p>
									Peso (en Kg):<br> ${ physicalDetail.weight }
								</p>
								<p>
									I.M.C (Índice de masa corporal):<br> ${ physicalDetail.patientIMC }
								</p>
							</div>
							<div class="contDer">
								<p>
									Presión Arterial (en mmHg):<br> ${ physicalDetail.bloodPressure }
								</p>
								<p>
									Ritmo Cardíaco (en ppm máx.):<br> ${ physicalDetail.heartRate }
								</p>
							</div>
						</c:if>
						...
						<c:if test="${ physicalDetail == null }">
							<div class="contIzq">
								<p>
									Altura (en m):<br> NO REGISTRADO
								</p>
								<p>
									Peso (en Kg):<br> NO REGISTRADO
								</p>
								<p>
									I.M.C (Índice de masa corporal):<br> NO REGISTRADO
								</p>
							</div>
							<div class="contDer">
								<p>
									Presión Arterial (en mmHg):<br> NO REGISTRADO
								</p>
								<p>
									Ritmo Cardíaco (en ppm máx.):<br> NO REGISTRADO
								</p>
							</div>
						</c:if>
					</div>
					...
					<div>
						...
						<div class="formFilter">
							<form class="filterForm" method="GET"
								action="/dashboard/${patient.id}">
								<label for="doctorFirstName">Nombre del Doctor:</label> <input
									class="inputDoctor" type="text" id="doctorFirstName"
									name="doctorFirstName" value="${param.doctorFirstName}">
								<br> <label for="date">Fecha:</label> <input type="date"
									id="date" name="createAt" value="${param.createAt}"> <br>
			...
			<div class="der">
				<div class="sup">
					...
					<div class="content">
						...
						<c:if test="${ treatment != null }">
							<p class="tipo">
								<b>Tipo: </b> <span>${ treatment.type }</span>
							</p>
							<p class="description">
								<b>Descripcion: </b> <br> <span>${ treatment.description }</span>
							</p>
						</c:if>
				...
				<div class="inf">
					...
					<div class="content">
						...
						<c:if test="${ antecedentDate != null }">
							<p>
								Fecha de Estudio: <br> ${ antecedentDate }
							</p>
							<p>
								Tipo: <br> ${ antecedent.type }
							</p>
							<p>
								Titulo: <br> ${ antecedent.title }
							</p>
							<p>
								Descripcion <br> ${ antecedent.description }
							</p>
						</c:if>
					</div>
